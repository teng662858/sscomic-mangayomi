...
const mangayomiSources = [
  {
    "name": "18禁漫",
    "lang": "zh",
    "baseUrl": "https://18jm18.com",
    "apiUrl": "",
    "iconUrl": "https://raw.githubusercontent.com/teng662858/sscomic-tachimanga/refs/heads/main/icons/jm18.png",
    "typeSource": "single",
    "itemType": 0,
    "isNsfw": true,
    "version": "0.1.2",
    "dateFormat": "",
    "dateFormatLocale": "",
    "pkgPath": "manga/src/zh/jm18.js",
  },
];

const MIRRORS = ["https://18jm18.com"];
const POPULAR = "/newupdate-comics?page={p}";
const LATEST = "/newupdate-comics?page={p}";
const SEARCH = "/cata.php?key={q}";
const CATALOGS = [{ name: "最近更新", value: "/newupdate-comics?page={p}" }, { name: "全部漫画", value: "/comic-lists/all/ob/time/st/all/page/{p}" }, { name: "已完结", value: "/comic-lists/all/ob/time/st/completed/page/{p}" }, { name: "连载中", value: "/comic-lists/all/ob/time/st/serialized/page/{p}" }, { name: "韩漫", value: "/comic-lists/韩漫/ob/time/st/all/page/{p}" }, { name: "日漫", value: "/comic-lists/日漫/ob/time/st/all/page/{p}" }, { name: "真人", value: "/comic-lists/真人/ob/time/st/all/page/{p}" }, { name: "3D漫画", value: "/comic-lists/3D漫画/ob/time/st/all/page/{p}" }];
const CARD_SEL = "a.hl-br-thumb, a[href*='/read-comics/'][title]";
const LINK_FROM = "";
const TITLE_FROM = "";
const COVER_FROM = "self";
const COVER_ATTRS = ["data-original", "data-src"];
const SKIP_SEL = "";
const DETAIL_TITLE = "h1";
const DETAIL_COVER = ".hl-detail-cover img, .comic-cover img, img[data-original]";
const CHAP_SEL = "a[href*='/read-comics/'][title*='第']";
const CHAP_NAME_ATTR = "title";
const IMG_SEL = "img[data-original], img.hl-lazy";
const IMG_ATTRS = ["data-original", "data-src", "src"];
