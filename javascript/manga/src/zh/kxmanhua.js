...
const mangayomiSources = [
  {
    "name": "开心看漫画",
    "lang": "zh",
    "baseUrl": "https://kxmanhua1.com",
    "apiUrl": "",
    "iconUrl": "https://raw.githubusercontent.com/teng662858/sscomic-tachimanga/refs/heads/main/icons/kxmanhua.png",
    "typeSource": "single",
    "itemType": 0,
    "isNsfw": true,
    "version": "0.1.1",
...
const MIRRORS = ["https://kxmanhua1.com", "https://kxmanhua.com"];
const POPULAR = "/manga/library?page={p}&ranktype=1&count=24";
const LATEST = "/manga/library?page={p}&orderby=3&count=24";
const SEARCH = "/manga/search?keyword={q}";
const CATALOGS = [{ name: "热门", value: "/manga/library?page={p}&ranktype=1&count=24" }, { name: "最新", value: "/manga/library?page={p}&orderby=3&count=24" }, { name: "排行榜", value: "/manga/rank" }];
const CARD_SEL = ".product__item";
const LINK_FROM = ".product__item__text h6 a, .set-bg";
const TITLE_FROM = ".product__item__text h6 a";
const COVER_FROM = ".set-bg";
const COVER_ATTRS = ["data-setbg"];
const SKIP_SEL = "";
const DETAIL_TITLE = "h1";
const DETAIL_COVER = ".anime__details__pic img, .product__item__pic";
const CHAP_SEL = "a[href*='/detail/']";
const CHAP_NAME_ATTR = "title";
const IMG_SEL = "img";
const IMG_ATTRS = ["src", "data-src"];
