...
const mangayomiSources = [
  {
    "name": "黄漫天堂",
    "lang": "zh",
    "baseUrl": "https://hman91.com",
    "apiUrl": "",
    "iconUrl": "https://raw.githubusercontent.com/teng662858/sscomic-tachimanga/refs/heads/main/icons/hman91.png",
    "typeSource": "single",
    "itemType": 0,
    "isNsfw": true,
    "version": "0.1.3",
    "dateFormat": "",
    "dateFormatLocale": "",
    "pkgPath": "manga/src/zh/hman91.js",
  },
];

const MIRRORS = ["https://hman91.com"];
const POPULAR = "/new-manga?page={p}";
const LATEST = "/new-manga?page={p}";
const SEARCH = "/cata.php?key={q}";
const CATALOGS = [{ name: "最近更新", value: "/new-manga?page={p}" }, { name: "全部漫画", value: "/manga-catalog/all/ob/time/st/all/page/{p}" }, { name: "已完结", value: "/manga-catalog/all/ob/time/st/completed/page/{p}" }, { name: "连载中", value: "/manga-catalog/all/ob/time/st/serialized/page/{p}" }, { name: "韩漫", value: "/manga-catalog/韩漫/ob/time/st/all/page/{p}" }, { name: "日漫", value: "/manga-catalog/日漫/ob/time/st/all/page/{p}" }, { name: "3D漫画", value: "/manga-catalog/3D漫画/ob/time/st/all/page/{p}" }, { name: "真人", value: "/manga-catalog/真人/ob/time/st/all/page/{p}" }];
const CARD_SEL = ".module-item";
