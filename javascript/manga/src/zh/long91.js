...
const mangayomiSources = [
  {
    "name": "龙禁漫",
    "lang": "zh",
    "baseUrl": "https://long91.com",
    "apiUrl": "",
    "iconUrl": "https://raw.githubusercontent.com/teng662858/sscomic-tachimanga/refs/heads/main/icons/long91.png",
    "typeSource": "single",
    "itemType": 0,
    "isNsfw": true,
    "version": "0.1.3",
    "dateFormat": "",
    "dateFormatLocale": "",
    "pkgPath": "manga/src/zh/long91.js",
  },
];

const MIRRORS = ["https://long91.com", "https://long52.com", "https://long92.org", "https://long91.xyz", "https://long91.org", "https://long7.org", "https://long5.org", "https://longjm.org"];
const POPULAR = "/newbook?page={p}";
const LATEST = "/newbook?page={p}";
const SEARCH = "/cata.php?key={q}";
const CATALOGS = [{ name: "最近更新", value: "/newbook?page={p}" }, { name: "全部漫画", value: "/bookcata/all/ob/time/st/all/page/{p}" }, { name: "已完结", value: "/bookcata/all/ob/time/st/completed/page/{p}" }, { name: "连载中", value: "/bookcata/all/ob/time/st/serialized/page/{p}" }, { name: "韩漫", value: "/bookcata/韩漫/ob/time/st/all/page/{p}" }, { name: "日漫", value: "/bookcata/日漫/ob/time/st/all/page/{p}" }, { name: "3D漫画", value: "/bookcata/3D漫画/ob/time/st/all/page/{p}" }, { name: "美女", value: "/bookcata/美女/ob/time/st/all/page/{p}" }, { name: "单本", value: "/bookcata/单本/ob/time/st/all/page/{p}" }];
const CARD_SEL = "a[href*='/manhua/'][title]:has(img)";
const LINK_FROM = "";
const TITLE_FROM = "";
const COVER_FROM = "img";
const COVER_ATTRS = ["data-src", "data-original", "src"];
const SKIP_SEL = "";
const DETAIL_TITLE = "h1";
const DETAIL_COVER = ".module-item-pic img, .detail-pic img";
const CHAP_SEL = "a.module-play-list-link";
