...
const mangayomiSources = [
  {
    "name": "妖精韩漫",
    "lang": "zh",
    "baseUrl": "https://www.yaojinghanman.com",
    "apiUrl": "",
    "iconUrl": "https://raw.githubusercontent.com/teng662858/sscomic-tachimanga/refs/heads/main/icons/yaojinghanman.png",
    "typeSource": "single",
    "itemType": 0,
    "isNsfw": true,
    "version": "0.1.4",
    "dateFormat": "",
    "dateFormatLocale": "",
    "pkgPath": "manga/src/zh/yaojinghanman.js",
  },
];

const MIRRORS = ["https://www.yaojinghanman.com"];
const POPULAR = "/category?page={p}";
const LATEST = "/category?page={p}";
const SEARCH = "/search?keyword={q}";
const CATALOGS = [{ name: "热门", value: "/category?page={p}" }, { name: "韩漫", value: "/category?Id=1&page={p}" }, { name: "BL耽美", value: "/category?Id=2&page={p}" }, { name: "AI漫画", value: "/category?Id=3&page={p}" }, { name: "3D漫画", value: "/category?Id=4&page={p}" }, { name: "汉化", value: "/category?Id=5&page={p}" }];
const CARD_SEL = "a[href*='/comic?Id='][title]";
const LINK_FROM = "";
const TITLE_FROM = "";
const COVER_FROM = "img";
const COVER_ATTRS = ["data-original", "src"];
const SKIP_SEL = "";
const DETAIL_TITLE = "h1";
const DETAIL_COVER = ".detail-main-cover img";
const CHAP_SEL = "a.chapteritem";
const CHAP_NAME_ATTR = "title";
const IMG_SEL = "img.lazy, img[data-original]";
const IMG_ATTRS = ["data-original", "src"];
