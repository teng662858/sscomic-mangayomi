...
const mangayomiSources = [
  {
    "name": "X漫",
    "lang": "zh",
    "baseUrl": "https://xman92.com",
    "apiUrl": "",
    "iconUrl": "https://raw.githubusercontent.com/teng662858/sscomic-tachimanga/refs/heads/main/icons/xman92.png",
    "typeSource": "single",
    "itemType": 0,
    "isNsfw": true,
    "version": "0.1.1",
    "dateFormat": "",
    "dateFormatLocale": "",
    "pkgPath": "manga/src/zh/xman92.js",
  },
];

const MIRRORS = ["https://xman92.com"];
const POPULAR = "/";
const LATEST = "/nm";
const SEARCH = "/cata.php?key={q}";
const CATALOGS = [{ name: "首页推荐", value: "/" }, { name: "最新更新", value: "/nm" }, { name: "韩漫", value: "/mcata/韩漫/ob/time/st/all/page/{p}" }, { name: "日漫", value: "/mcata/日漫/ob/time/st/all/page/{p}" }, { name: "3D漫画", value: "/mcata/3D漫画/ob/time/st/all/page/{p}" }, { name: "真人美女", value: "/mcata/真人美女/ob/time/st/all/page/{p}" }, { name: "单本", value: "/mcata/单本/ob/time/st/all/page/{p}" }];
const CARD_SEL = "a.wbalist_thumb, a[href*='/mdetail/'][title]";
const LINK_FROM = "";
const TITLE_FROM = "";
const COVER_FROM = "self";
const COVER_ATTRS = [];
const SKIP_SEL = ".pops_list";
const DETAIL_TITLE = "h1";
const DETAIL_COVER = ".bgi, .detail-pic img";
const CHAP_SEL = "a[href*='/mread/']";
