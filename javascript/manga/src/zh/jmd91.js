...
const mangayomiSources = [
  {
    "name": "禁漫岛",
    "lang": "zh",
    "baseUrl": "https://91jmd.com",
    "apiUrl": "",
    "iconUrl": "https://raw.githubusercontent.com/teng662858/sscomic-tachimanga/refs/heads/main/icons/jmd91.png",
    "typeSource": "single",
    "itemType": 0,
    "isNsfw": true,
    "version": "0.1.4",
    "dateFormat": "",
    "dateFormatLocale": "",
    "pkgPath": "manga/src/zh/jmd91.js",
  },
];

const MIRRORS = ["https://91jmd.com"];
const POPULAR = "/update?page={p}";
const LATEST = "/update?page={p}";
const SEARCH = "/cata.php?key={q}";
const CATALOGS = [{ name: "最近更新", value: "/update?page={p}" }, { name: "全部漫画", value: "/catalog/all/ob/time/st/all/page/{p}" }, { name: "已完结", value: "/catalog/all/ob/time/st/completed/page/{p}" }, { name: "连载中", value: "/catalog/all/ob/time/st/serialized/page/{p}" }, { name: "韩漫", value: "/catalog/韩漫/ob/time/st/all/page/{p}" }, { name: "日漫", value: "/catalog/日漫/ob/time/st/all/page/{p}" }, { name: "3D漫画", value: "/catalog/3D漫画/ob/time/st/all/page/{p}" }, { name: "真人", value: "/catalog/真人/ob/time/st/all/page/{p}" }, { name: "短篇", value: "/catalog/短篇/ob/time/st/all/page/{p}" }];
const CARD_SEL = ".module-item, a.thumbnail";
const LINK_FROM = ".module-item-pic a, .module-item-titlebox a";
const TITLE_FROM = ".module-item-titlebox a, .module-item-pic a";
