...
const mangayomiSources = [
  {
    "name": "鸟鸟韩漫",
    "lang": "zh",
    "baseUrl": "https://nnhanman.com",
    "apiUrl": "",
    "iconUrl": "https://raw.githubusercontent.com/teng662858/sscomic-tachimanga/refs/heads/main/icons/nnhm91.png",
    "typeSource": "single",
    "itemType": 0,
    "isNsfw": true,
    "version": "0.1.4",
    "dateFormat": "",
    "dateFormatLocale": "",
    "pkgPath": "manga/src/zh/nnhm91.js",
  },
];

const MIRRORS = ["https://nnhanman.com", "https://c.nnhanman.com", "https://nnhm91.com"];
const POPULAR = "/comics/all/ob/hits/st/all/page/{p}";
const LATEST = "/comics/all/ob/time/st/all/page/{p}";
const SEARCH = "/catalog.php?key={q}";
const CATALOGS = [{ name: "热门", value: "/comics/all/ob/hits/st/all/page/{p}" }, { name: "最新", value: "/comics/all/ob/time/st/all/page/{p}" }, { name: "已完结", value: "/comics/all/ob/time/st/completed/page/{p}" }, { name: "连载中", value: "/comics/all/ob/time/st/serialized/page/{p}" }, { name: "正妹", value: "/comics/正妹/ob/time/st/all/page/{p}" }, { name: "恋爱", value: "/comics/恋爱/ob/time/st/all/page/{p}" }, { name: "出版漫画", value: "/comics/出版漫画/ob/time/st/all/page/{p}" }, { name: "肉慾", value: "/comics/肉慾/ob/time/st/all/page/{p}" }, { name: "浪漫", value: "/comics/浪漫/ob/time/st/all/page/{p}" }, { name: "大尺度", value: "/comics/大尺度/ob/time/st/all/page/{p}" }, { name: "巨乳", value: "/comics/巨乳/ob/time/st/all/page/{p}" }, { name: "同居", value: "/comics/同居/ob/time/st/all/page/{p}" }, { name: "調教", value: "/comics/調教/ob/time/st/all/page/{p}" }, { name: "動作", value: "/comics/动作/ob/time/st/all/page/{p}" }, { name: "後宮", value: "/comics/後宮/ob/time/st/all/page/{p}" }, { name: "3D", value: "/comics/3D/ob/time/st/all/page/{p}" }, { name: "校園", value: "/comics/校園/ob/time/st/all/page/{p}" }, { name: "耽美", value: "/comics/耽美/ob/time/st/all/page/{p}" }, { name: "日漫", value: "/comics/日漫/ob/time/st/all/page/{p}" }];
const CARD_SEL = ".itemBox, a.ImgA";
const LINK_FROM = ".itemImg a, .itemTxt a.title";
const TITLE_FROM = ".itemTxt a.title, .itemImg a";
const COVER_FROM = "img";
const COVER_ATTRS = ["data-src", "src"];
const SKIP_SEL = "";
const DETAIL_TITLE = "h1";
const DETAIL_COVER = ".detailImg img, .comicImg img";
const CHAP_SEL = "a[href*='chapter-']";
const CHAP_NAME_ATTR = "title";
const IMG_SEL = ".img-wrap img, img[data-src]";
