...
const mangayomiSources = [
  {
    "name": "P5韩漫",
    "lang": "zh",
    "baseUrl": "https://www3.5p5mh7.click",
    "apiUrl": "",
    "iconUrl": "https://raw.githubusercontent.com/teng662858/sscomic-tachimanga/refs/heads/main/icons/p5mh.png",
    "typeSource": "single",
    "itemType": 0,
    "isNsfw": true,
    "version": "0.1.4",
...
const MIRRORS = ["https://www3.5p5mh7.click", "https://www3.6p5mh2.click", "https://www.5imanhua.net", "https://www.p5mh.com", "https://www.ip5mh.com"];
const POPULAR = "/booklist?page={p}";
const LATEST = "/update?page={p}";
const SEARCH = "/search?key={q}";
const CATALOGS = [{ name: "全部漫画", value: "/booklist?page={p}" }, { name: "已完结", value: "/booklist?end=1&page={p}" }, { name: "最近更新", value: "/update?page={p}" }, { name: "排行榜", value: "/rank" }];
const CARD_SEL = "a:has(.mh-cover)";
const LINK_FROM = "";
const TITLE_FROM = ".mh-item-detail a, .info a, .title a";
const COVER_FROM = ".mh-cover";
const COVER_ATTRS = ["data-original", "data-src", "src"];
const SKIP_SEL = "";
const DETAIL_TITLE = "h1";
const DETAIL_COVER = ".banner_detail_bg, .cover .lazy, .cover img";
const CHAP_SEL = "a[href*='/chapter/']";
const CHAP_NAME_ATTR = "";
const IMG_SEL = "img[data-original], .content img";
