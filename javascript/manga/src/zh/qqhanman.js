...
const mangayomiSources = [
  {
    "name": "七七韩漫",
    "lang": "zh",
    "baseUrl": "https://www.qqhanman.com",
    "apiUrl": "",
    "iconUrl": "https://raw.githubusercontent.com/teng662858/sscomic-tachimanga/refs/heads/main/icons/qqhanman.png",
    "typeSource": "single",
    "itemType": 0,
    "isNsfw": true,
    "version": "0.1.1",
    "dateFormat": "",
    "dateFormatLocale": "",
    "pkgPath": "manga/src/zh/qqhanman.js",
  },
];

const MIRRORS = ["https://www.qqhanman.com"];
...
const CARD_SEL = ".book_list a[title]";
const LINK_FROM = "";
const TITLE_FROM = "";
const COVER_FROM = "img";
const COVER_ATTRS = ["src", "data-original"];
const SKIP_SEL = "";
const DETAIL_TITLE = "h1";
const DETAIL_COVER = ".detail-main-cover img, .cover, img[data-original]";
const CHAP_SEL = "a[href*='/chapter']";
const CHAP_NAME_ATTR = "title";
const IMG_SEL = "img[data-src], img.lazy";
